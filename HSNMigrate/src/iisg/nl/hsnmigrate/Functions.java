...
public class Functions {
	...
	public static String prefix_r(String prefix, int errCode, int idnr, int year, String db, String tbl){
		...
		if(prefix != null && prefix.trim().length() != 0){
			...
			if(p != null  && p.getCode() != null && (p.getCode().equalsIgnoreCase("j") == true || p.getCode().equalsIgnoreCase("o") == true) && p.getPrefix() != null && p.getPrefix().length() > 0){
				return p.getPrefix();
			}
			else{
				if(p == null){
	...
	public static String profession_r(String profession, int errCode, int idnr, int year, String db, String tbl){
		...
		if(profession != null && profession.trim().length() != 0){
			...
			if(p != null  && p.getCode() != null && (p.getCode().equalsIgnoreCase("j") == true || p.getCode().equalsIgnoreCase("o") == true) && p.getProfession() != null && p.getProfession().length() > 0){
	...
	public static String location_r(String location, int errCode, int idnr, int year, String db, String tbl){
		...
		if(location != null && location.trim().length() != 0){
			...
			if(l != null  && l.getStandardCode() != null && (l.getStandardCode().equalsIgnoreCase("y") == true || l.getStandardCode().equalsIgnoreCase("u") == true) && l.getLocation() != null && l.getLocation().length() > 0){
