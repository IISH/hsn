...
public class PopRegDeleteFromDefDBDialog extends JDialog {
    private boolean confirm = false;

    public PopRegDeleteFromDefDBDialog(Frame parent) {
        initComponents();
        ...
        this.setTitle("Please confirm input DBF file");
...
// add your code here if necessary
    ...
    public void setInputFileField(String inputDirectory){
        inputFileTextField.setText(inputDirectory);
    }
	...
	private void initComponents() {
		...
		//======== contentPane ========
		{
			...
			//======== panel3 ========
			{
				...
				//---- inputFileLabel ----
				inputFileLabel.setText("Input DBF file:");
				panel3.add(inputFileLabel, new GridConstraints(0, 0, 1, 1,
				...
				panel3.add(vSpacer1, new GridConstraints(1, 0, 1, 1,
					...
					GridConstraints.SIZEPOLICY_CAN_GROW | GridConstraints.SIZEPOLICY_WANT_GROW,
					null, null, null));
				panel3.add(inputFileTextField, new GridConstraints(0, 1, 1, 1,
