...
public class SpecifyWorkItem extends JDialog {
    private boolean confirm = false;

    public SpecifyWorkItem(Frame parent) {
        initComponents();
        ...
        this.setTitle("Please specify workitem (opdrachtnummer)");
...
// call onCancel() on ESCAPE
    ...
    public String getInputDirectoryField(){
        return inputDirectoryField.getText();
    }
	...
	private void initComponents() {
		...
		//======== contentPane ========
		{
			...
			contentPane.setPreferredSize(new Dimension(300, 80)); // was 600, 80
			//======== panel1 ========
			{
			...
			//======== panel3 ========
			{
				...
				//---- inputDirectoryLabel ----
				inputDirectoryLabel.setText("Workitem (Opdrachtnummer):");
