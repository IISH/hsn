...
public class Constants {
	...
	//static String links_match = node + "links_match?user=links&password=mslinks";
	//static String links_ids   = node + "links_ids?user=links&password=mslinks";
	//static String links_base  = node + "links_base?user=links&password=mslinks";
