...
public class M1 {
     ...
     public void convert(EntityManager em){   
    	 ...
    	 String MC = "Marriage Certificate";
		 ...
		 if(ceMarriage != null){
			 ...
			 Utils.addIndivAndContext(null, null, null, null, ceMarriage, em, getIdnr(), Id_I_BR, "MC M1", "MARRIAGE_LOCATION", "Event", "Exact", getMar_cd(), getMar_cm(), getMar_cy());
			 Utils.addIndivContextAndContextCertificate(getMar_cy(), getM1sdcn(), ceMarriage, em, getIdnr(), Id_I_BR, MC, "MC M1", "Bride", "Event", "Exact", getMar_cd(), getMar_cm(), getMar_cy());
		 }
    	 ...
    	 if(getM1brll() != null && getM1brll().trim().length() > 0){
    		 ...
    		 if(ce != null)
    			 //Utils.addIndivContextAndContext(null, ce, em, getIdnr(), Id_I_BR, "MC M1", "Address", "Declared", "Exact", getMar_cd(), getMar_cm(), getMar_cy());
    		 	 Utils.addIndivAndContext(null, ce, em, getIdnr(), Id_I_BR, "MC M1", "RESIDENCE_LOCATION", "Declared", "Exact", getMar_cd(), getMar_cm(), getMar_cy());
		 ...
		 if(getM1gfln() != null && getM1gfln().trim().length() > 0 && !getM1gfln().trim().equalsIgnoreCase("N")){
			 ...
			 if(getM1gfay() > 0){
				 ...
				 int[] a = Utils.range(100, 30, getMar_cd(), getMar_cm(), getMar_cy());					 
				 Utils.addIndiv(em, getIdnr(), Id_I_GF, "MC M1", "BIRTH_DATE", null, "Declared", "Estimated [30/100]", 
				 ...
				 if(getM1gfll() != null){
					 ...
					 if(ce != null)
						 //Utils.addIndivContextAndContext(null, ce, em, getIdnr(), Id_I_GF, "MC M1", "Address", "Declared", "Exact", getMar_cd(), getMar_cm(), getMar_cy());
     	    		 	 Utils.addIndivAndContext(null, ce, em, getIdnr(), Id_I_GF, "MC M1", "RESIDENCE_LOCATION", "Declared", "Exact", getMar_cd(), getMar_cm(), getMar_cy());
			 ...
			 if(ceMarriage != null){
				 Utils.addIndivContextAndContextCertificate(getMar_cy(), getM1sdcn(), ceMarriage, em, getIdnr(), Id_I_GF, MC, "MC M1", "Father Groom", "Event", "Exact", getMar_cd(), getMar_cm(), getMar_cy());
			 }
		 ...
		 if(getM1gmln() != null && getM1gmln().trim().length() > 0 && !getM1gmln().trim().equalsIgnoreCase("N")){
			 ...
			 if(getM1gmay() > 0){
				 ...
				 int[] a = Utils.range(100, 30, getMar_cd(), getMar_cm(), getMar_cy());					
				 Utils.addIndiv(em, getIdnr(), Id_I_GM, "MC M1", "BIRTH_DATE", null, "Declared", "Estimated [30/100]", 
						 a[0], a[1], a[2], a[3], a[4], a[5]);
			 }
				 ...
				 if(getM1gmll() != null){
					 ...
					 if(ce != null)
						 //Utils.addIndivContextAndContext(null, ce, em, getIdnr(), Id_I_GM, "MC M1", "Address", "Declared", "Exact", getMar_cd(), getMar_cm(), getMar_cy());
					 	 Utils.addIndivAndContext(null, ce, em, getIdnr(), Id_I_GM, "MC M1", "RESIDENCE_LOCATION", "Declared", "Exact", getMar_cd(), getMar_cm(), getMar_cy());
			 ...
			 if(ceMarriage != null){
				 Utils.addIndivContextAndContextCertificate(getMar_cy(), getM1sdcn(), ceMarriage, em, getIdnr(), Id_I_GM, MC, "MC M1", "Mother Groom", "Event", "Exact", getMar_cd(), getMar_cm(), getMar_cy());
			 }
		 ...
		 if(getM1bfln() != null && getM1bfln().trim().length() > 0 && !getM1bfln().trim().equalsIgnoreCase("N")){
			 ...
			 if(getM1bfay() > 0){
				 ...
				 int[] a = Utils.range(100, 30, getMar_cd(), getMar_cm(), getMar_cy());					
				 Utils.addIndiv(em, getIdnr(), Id_I_BF, "MC M1", "BIRTH_DATE", null, "Declared", "Estimated [30/100]", 
						 a[0], a[1], a[2], a[3], a[4], a[5]);
			 }
				 ...
				 if(getM1bfll() != null){
					 ...
					 if(ce != null)
						 //Utils.addIndivContextAndContext(null, ce, em, getIdnr(), Id_I_BF, "MC M1", "Address", "Declared", "Exact", getMar_cd(), getMar_cm(), getMar_cy());
     	    		 	 Utils.addIndivAndContext(null, ce, em, getIdnr(), Id_I_BF, "MC M1", "RESIDENCE_LOCATION", "Declared", "Exact", getMar_cd(), getMar_cm(), getMar_cy());
			 ...
			 if(ceMarriage != null){
				 Utils.addIndivContextAndContextCertificate(getMar_cy(), getM1sdcn(), ceMarriage, em, getIdnr(), Id_I_BF, MC, "MC M1", "Father Bride", "Event", "Exact", getMar_cd(), getMar_cm(), getMar_cy());
			 }
		 ...
		 if(getM1bmln() != null && getM1bmln().trim().length() > 0 && !getM1bmln().trim().equalsIgnoreCase("N")){
			 ...
			 if(getM1bmay() > 0){
				 ...
				 int[] a = Utils.range(100, 30, getMar_cd(), getMar_cm(), getMar_cy());					
				 Utils.addIndiv(em, getIdnr(), Id_I_BM, "MC M1", "BIRTH_DATE", null, "Declared", "Estimated [30/100]", 
						 a[0], a[1], a[2], a[3], a[4], a[5]);
			 }
				 ...
				 if(getM1bmll() != null){
					 ...
					 if(ce != null)
						 //Utils.addIndivContextAndContext(null, ce, em, getIdnr(), Id_I_BM, "MC M1", "Address", "Declared", "Exact", getMar_cd(), getMar_cm(), getMar_cy());
					 	 Utils.addIndivAndContext(null, ce, em, getIdnr(), Id_I_BM, "MC M1", "RESIDENCE_LOCATION", "Declared", "Exact", getMar_cd(), getMar_cm(), getMar_cy());
