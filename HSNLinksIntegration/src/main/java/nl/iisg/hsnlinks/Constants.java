...
public class Constants {
	...
	//static String hsn_ids = node + "hsn_ids?user=cor&password=q1w2e3r4";
	...
	static String links_ids         = "links_ids";       // INDIVIDUAL, INDIV_INDIV, INDIV_CONTEXT, CONTEXT, CONTEXT_CONTEXT, Persons  
	static String links_hns_ids     = "links_hsn_ids";   // INDIVIDUAL, INDIV_INDIV, INDIV_CONTEXT, CONTEXT, CONTEXT_CONTEXT, Persons  
}
